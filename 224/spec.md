> **Full spec and artifacts: [`.issues/1430/`](https://github.com/michael-conrad/opencode-config/tree/issues-data/1430)** — this issue is a condensed exec summary; the authoritative spec lives in the `issues-data` branch.
>
